...
void RoomServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RoomServer::*)(const QString & )>(_a, &RoomServer::log, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RoomServer::*)(const QJsonObject & )>(_a, &RoomServer::messageReceived, 1))
            return;
    }
}
...
// SIGNAL 0
void RoomServer::log(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void RoomServer::messageReceived(const QJsonObject & _t1)
{

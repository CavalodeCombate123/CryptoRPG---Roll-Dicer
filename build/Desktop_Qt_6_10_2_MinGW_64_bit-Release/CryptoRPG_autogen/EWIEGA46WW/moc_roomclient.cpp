...
void RoomClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (RoomClient::*)()>(_a, &RoomClient::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (RoomClient::*)(const QString & )>(_a, &RoomClient::error, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (RoomClient::*)(const QJsonObject & )>(_a, &RoomClient::messageReceived, 3))
            return;
    }
}
...
// SIGNAL 2
void RoomClient::error(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void RoomClient::messageReceived(const QJsonObject & _t1)
{
